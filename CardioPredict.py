...
def generate_report_pdf(user_vals, risk_label, percent, df_table=None):
    ...
    pdf.cell(0, 10, "CardioSafe AI: Clinical Risk Assessment", ln=True, align="C")
    pdf.ln(10)
...
# 3. Main Application
# -----------------------------
st.set_page_config(page_title="CardioSafe AI", layout="wide")

st.markdown("""
    <div style="background-color: #0f172a; padding: 25px; border-radius: 10px; margin-bottom: 25px; border-left: 10px solid #dc2626;">
        <h1 style="color: white; margin: 0;">CardioSafe AI</h1>
        <p style="color: #94a3b8; margin: 0; font-size: 1.1rem;">Clinical Intelligence Platform for CVD Risk (WHO Alignment)</p>
    </div>
